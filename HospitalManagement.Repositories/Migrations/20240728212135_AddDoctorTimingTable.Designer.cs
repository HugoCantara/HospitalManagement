...
namespace HospitalManagement.Repositories.Migrations
{
    ...
    [Migration("20240728212135_AddDoctorTimingTable")]
    partial class AddDoctorTimingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagement.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HospitalManagement.Models.Payroll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HospitalManagement.Models.PrescribedMedicine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HospitalManagement.Models.TestPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HospitalManagement.Models.Appointment", b =>
                {
                    b.HasOne("HospitalManagement.Models.ApplicationUser", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId");

                    b.HasOne("HospitalManagement.Models.ApplicationUser", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("HospitalManagement.Models.Payroll", b =>
                {
                    b.HasOne("HospitalManagement.Models.ApplicationUser", "EmployeeId")
                        .WithMany()
            ...
            modelBuilder.Entity("HospitalManagement.Models.PrescribedMedicine", b =>
                {
                    ...
                    b.HasOne("HospitalManagement.Models.PatientReport", "PatientReport")
                        .WithMany("PrescribedMedicines")
